...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset('asset/admin/plugins/fontawesome-free/css/all.min.css') }}"
    />
    <!-- Ionicons -->
    <link
      rel="stylesheet"
    ...
    <link
      rel="stylesheet"
      href="{{ asset('asset/admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}"
    />
    <!-- JQVMap -->
    <link
      rel="stylesheet"
      href="{{ asset('asset/admin/plugins/jqvmap/jqvmap.min.css') }}"
    />
    <!-- Theme style -->
    <link
      rel="stylesheet"
      href="{{ asset('asset/admin/dist/css/adminlte.min.css') }}"
    />
    <!-- overlayScrollbars -->
    <link
      rel="stylesheet"
      href="{{ asset('asset/admin/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}"
    />
    <!-- Daterange picker -->
    <link
      rel="stylesheet"
      href="{{ asset('asset/admin/plugins/daterangepicker/daterangepicker.css') }}"
    />
    <!-- summernote -->
    <link
      rel="stylesheet"
      href="{{ asset('asset/admin/plugins/summernote/summernote-bs4.css') }}"
    />
    ...
    <div class="wrapper">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  <img
                    src="{{ asset('asset/admin/dist/img/user1-128x128.jpg') }}"
                    alt="User Avatar"
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  <img
                    src="{{ asset('asset/admin/dist/img/user8-128x128.jpg') }}"
                    alt="User Avatar"
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  <img
                    src="{{ asset('asset/admin/dist/img/user3-128x128.jpg') }}"
                    alt="User Avatar"
                    class="img-size-50 img-circle mr-3"
                  />
                  <div class="media-body">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
          <img
            src="{{ asset('asset/admin/dist/img/AdminLTELogo.png') }}"
            alt="AdminLTE Logo"
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img
                src="{{ asset('asset/admin/dist/img/user2-160x160.jpg') }}"
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ asset('asset/admin/dist/img/user7-128x128.jpg') }}"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ asset('asset/admin/dist/img/user5-128x128.jpg') }}"
                            />
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ asset('asset/admin/dist/img/user6-128x128.jpg') }}"
                            />
